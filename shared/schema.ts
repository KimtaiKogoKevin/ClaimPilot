...
export const photoAngleEnum = pgEnum('photo_angle', ['FRONT_VIEW', 'REAR_VIEW', 'LEFT_SIDE', 'RIGHT_SIDE', 'DAMAGE_CLOSEUP', 'accident_sketch', 'logbook', 'policeAbstract', 'license', 'police_report', 'insurance_certificate', 'other_document']);
